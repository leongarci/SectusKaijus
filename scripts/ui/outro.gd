...
# --- DONNÉES ---
var Outro = [
	"Je ne peux que vous féliciter mon cher Titouan",
...
@onready var label_texte = $TexteHistoireOutro
@onready var bouton_suite = $BoutonSuiteOutro
@onready var fond_dialogue = $DialogueOutro
@onready var video = $VideoStreamPlayerOutro
...
func afficher_texte_anime():
	...
	var texte_a_afficher = Outro[etape_actuelle]
